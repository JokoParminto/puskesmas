    ...
    <div class="card">
        ...
        <div class="">
					...
					<li class="nav-item"> <a class="nav-link <?= isset($_GET['typelaporan']) ? '' : 'active show' ?>" data-toggle="tab" href="#daftarpasien" role="tab" aria-selected="true"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">Laporan Daftar pasien</span></a> </li>
							...
							<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#pemeriksaan" role="tab"><span class="hidden-sm-up"><i class="ti-email"></i></span> <span class="hidden-xs-down">Laporan Pemeriksaan</span></a> </li>
...
$(document).ready(function() {
	...
	$('#reloadlaporaninap').on('click', function(){
		console.log('a');
		window.location.href = 'laporan.php?typelaporan='+$(this).attr('data')+'&startdate='+$('#tgl').val();
	});
	$('#reloadlaporanumur').on('click', function(){
		console.log('a');
		window.location.href = 'laporan.php?typelaporan='+$(this).attr('data')+'&umur='+$('#umur').val();
	});
	$('#reloadlaporankelamin').on('click', function(){
		console.log('a');
		window.location.href = 'laporan.php?typelaporan='+$(this).attr('data')+'&jeniskelamin='+$('#jeniskelamin').val();
	});
	$('#reloadlaporanobat').on('click', function(){
		console.log('a');
		window.location.href = 'laporan.php?typelaporan='+$(this).attr('data')+'&tglobat='+$('#tgl-obat').val();
	});
	$('#reloadlaporanpenyakit').on('click', function(){
		window.location.href = 'laporan.php?typelaporan='+$(this).attr('data')+'&diagnosa='+$('#diagnosa').val()+'&tglawal='+$('#tgl-awal').val()+'&tglakhir='+$('#tgl-akhir').val();
	});
	$('#reloadlaporankode').on('click', function(){
		...
		window.location.href = 'laporan.php?typelaporan='+$(this).attr('data')+'&idpasien='+$('#id-pasien').val();
	});
</script>
</html>
