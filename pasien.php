								...
								<div class="basic-form">
									<form action="pasien_action.php" method="post">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="nama_pasien" placeholder="Nama Pasien" id="nama_pasien">
										</div>
										<div class="form-group">
											<label for="">Alamat</label>
											<textarea class="form-control" name="alamat" class="form-control" cols="30" rows="10" id="alamat"></textarea>
										</div>
										<div class="row">
